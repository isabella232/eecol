    ...
    const navToolbar = /* html */`
      <div class="nav-toolbar-logo">
        <picture>
          ...
          <img loading="lazy" alt="Home" type="image/png" src="./media_11e0e648e5f78452ada12404956dff13905bac140.png?width=278&amp;format=webp&amp;optimize=medium" width="139" height="45">
        </picture>
      </div>
