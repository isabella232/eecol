    ...
    const navToolbar = /* html */`
      <div class="nav-toolbar-logo">
        <picture>
          ...
          <img loading="lazy" alt="Home" type="image/png" src="./media_11e0e648e5f78452ada12404956dff13905bac140.png?width=750&amp;format=png&amp;optimize=medium" width="1600" height="515">
        </picture>
      </div>
